...
const cursorValue = computed(() => {
	const alias = props.alias[cursor.value]
	const value = props.values[cursor.value]
	if (value !== props.modelValue) return props.default
	return alias || value || props.default
})
