...
:root {
   ...
   /* 左上图标 */
   --image-icon: url(lfp://custom/icons/ra2icon.png) center / contain no-repeat;
   /* 编辑器背景 */
   --image-editor: ;
   /* 左侧边栏底纹 */
   --image-lefttab: ;
...
#object-editor {
   --line-height: 26px;
   --textbox-radius: 13px;
   --color-bg-1: rgba(56, 86, 117, 0.167);
   --color-bg-2: rgba(102, 129, 116, 0.272);
   --color-bg-3: rgba(48, 89, 112, 0.155);
   --color-bg-4: rgba(129, 115, 162, 0.105);
   --color-bg-5: rgba(135, 179, 222, 0.667);
   --color-t-1: rgba(205, 204, 185, 0.715);
   --color-t-2: rgba(251, 248, 214, 0.865);
   --color-t-3: rgba(251, 248, 214, 0.865);
   --color-t-4: rgba(251, 248, 214, 0.865);
   --color-t-5: rgba(237, 244, 167, 0.9);
}
`
